...
<img src='https://submissions.us-east-1.linodeobjects.com/android_university/PUZEeYko.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [ScreentoGif].

## Notes

Changes seemed to lag, it would they would appear when run a second time. I could not get the timeline to keep from showing a duplicate tweet between "pages." I understood how adjusting the maxId was supposed to avoid that but I could not make it work.
